                        ...
                        <tbody>
                            <%
                                ...
                                for (Administrador administrador : listaAdministradores) {
                                    ...
                                    out.println("<th>" + administrador.getAprovado() + "</th>");
                                    out.println("<th>" + administrador.getEndereco() + "</th>");
                                    %>
                            <td>
                            <a href="/aplicacaoMVC/admin/AdministradorController?acao=Alterar&id=<%=administrador.getId()%>" class="btn btn-warning">Alterar</a>
                            <a href="/aplicacaoMVC/admin/AdministradorController?acao=Excluir&id=<%=administrador.getId()%>" class="btn btn-danger">Excluir</a></td>
